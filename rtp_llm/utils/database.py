...
class CkptDatabase(BaseDatabase):
    ...
    def preload_lora_tensors(
        ...
        """Preload all tensors for a LoRA adapter via batch I/O. See LoraCkpt.preload_lora_tensors()."""
        return self.lora_ckpt.preload_lora_tensors(lora_name, device)
    ...
    def load_lora_tensor_from_cache(
        ...
        """Load a single tensor from a pre-loaded cache. See LoraCkpt.load_lora_tensor_from_cache()."""
        return self.lora_ckpt.load_lora_tensor_from_cache(
